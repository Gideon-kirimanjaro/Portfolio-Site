<template>
  <div>
                  ...
                  >
                    ...
                    <a class="hex-content">
                      <span class="hex-content-inner">
                        <span class="icon">
                          &emsp;&emsp;
                          <font-awesome-icon :icon="item.svg" />
                        </span>
    ...
    <div ref="about">
      <div id="logo" ref="welcome" class="d-flex justify-content-center">
        <img height="300" width="300" src="@/static/images/logo.png" alt="" />
      </div>
      <Profile />
    </div>
    <div ref="services">
  ...
  data: () => {
    return {
      db: [
        ...
        { title: 'Contact', svg: ['fas', 'rss'], id: 'contact' },
      ],
    }
  },
  methods: {
