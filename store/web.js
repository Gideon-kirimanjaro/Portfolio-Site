  ...
  images: [
    {
      ...
      description:
        ' This is a website for a NGO. This website attracted donor funding to run the project and in turn proppeled the mitigation of food insecurity in 3 counties namely: Meru county, Embu county and tharakanithi county',
      header: 'Gray Agro website',
    },
    {
      id: Math.random(),
      name: 'site5',
      url: 'https://quadstravelagency.com/',
      hub: 'https://github.com/Gideon-kirimanjaro/visitors-App-React',
      description:
        ' I designed and built this website for Quads Travels tour company. Through the site the company received a 40% increase in overall sales.',
      header: 'Quads Travel website',
    },
    {
      id: Math.random(),
      name: 'site7',
